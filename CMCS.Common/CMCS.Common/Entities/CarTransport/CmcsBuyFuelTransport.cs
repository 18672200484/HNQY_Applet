...
namespace CMCS.Common.Entities.CarTransport
{
	...
	public class CmcsBuyFuelTransport : EntityBase1
	{
		...
		private string _GrossUser;
		/// <summary>
		/// 毛重操作人
		/// </summary>
		public virtual string GrossUser { get { return _GrossUser; } set { _GrossUser = value; } }
		...
		private string _TareUser;
		/// <summary>
		/// 皮重操作人
		/// </summary>
		public virtual string TareUser { get { return _TareUser; } set { _TareUser = value; } }
		...
		/// 采样人
		/// </summary>
		public virtual string SampleUser { get { return _SampleUser; } set { _SampleUser = value; } }
