...
namespace CMCS.Monitor.Win.Frms
{
    public partial class FrmAutoMaker : MetroForm
    {
        ...
        void RequestData()
        {
            ...
            string machineCode = string.Empty, equInfSamplerSystemStatus = string.Empty;
            ...
            //value2 = commonDAO.GetSignalDataValue(machineCode, "6mm破碎");
            //value3 = commonDAO.GetSignalDataValue(machineCode, "3mm破碎");
            //value4 = commonDAO.GetSignalDataValue(machineCode, "0.2mm破碎");
            //value5 = commonDAO.GetSignalDataValue(machineCode, "6mm缩分");
            //value6 = commonDAO.GetSignalDataValue(machineCode, "3mm缩分");
            //value7 = commonDAO.GetSignalDataValue(machineCode, "6mm输送机");
            //value8 = commonDAO.GetSignalDataValue(machineCode, "3mm输送机");
            //value9 = commonDAO.GetSignalDataValue(machineCode, "0.2mm输送机");
            //value10 = commonDAO.GetSignalDataValue(machineCode, "弃料输送机");
            //value11 = commonDAO.GetSignalDataValue(machineCode, "转接弃料输送机");
            //value12 = commonDAO.GetSignalDataValue(machineCode, "红外干燥");
            //value13 = commonDAO.GetSignalDataValue(machineCode, "进瓶信号");
            //datas.Add(new HtmlDataItem("一级加料输送机", value1 == "1" ? red : green, eHtmlDataItemType.svg_color));
            //datas.Add(new HtmlDataItem("6mm破碎", commonDAO.GetSignalDataValue(machineCode, "6mm破碎"), eHtmlDataItemType.svg_color));
            //datas.Add(new HtmlDataItem("6mm缩分", commonDAO.GetSignalDataValue(machineCode, "6mm缩分"), eHtmlDataItemType.svg_color));
            //datas.Add(new HtmlDataItem("3mm破碎", commonDAO.GetSignalDataValue(machineCode, "3mm破碎"), eHtmlDataItemType.svg_color));
            //datas.Add(new HtmlDataItem("3mm缩分", commonDAO.GetSignalDataValue(machineCode, "3mm缩分"), eHtmlDataItemType.svg_color));
            //datas.Add(new HtmlDataItem("02mm破碎", commonDAO.GetSignalDataValue(machineCode, "0.2mm破碎"), eHtmlDataItemType.svg_color));
            //datas.Add(new HtmlDataItem("02mm缩分", commonDAO.GetSignalDataValue(machineCode, "0.2mm缩分"), eHtmlDataItemType.svg_color));
            ...
            //datas.Add(new HtmlDataItem("开始时间", ConvertSignalValue(commonDAO.GetSignalDataValue(machineCode, "截取开始时间")), eHtmlDataItemType.svg_text));
            //datas.Add(new HtmlDataItem("煤种", ConvertSignalValue(commonDAO.GetSignalDataValue(machineCode, "煤种")), eHtmlDataItemType.svg_text));
            //datas.Add(new HtmlDataItem("水分", ConvertSignalValue(commonDAO.GetSignalDataValue(machineCode, "水分")), eHtmlDataItemType.svg_text));
            //datas.Add(new HtmlDataItem("粒度", ConvertSignalValue(commonDAO.GetSignalDataValue(machineCode, "粒度")), eHtmlDataItemType.svg_text));
            //datas.Add(new HtmlDataItem("一级加料称", ConvertSignalValue(commonDAO.GetSignalDataValue(machineCode, "一级加料称"), "kg"), eHtmlDataItemType.svg_text));
            //datas.Add(new HtmlDataItem("红外干燥实际温度", ConvertSignalValue(commonDAO.GetSignalDataValue(machineCode, "红外干燥实际温度"), "℃"), eHtmlDataItemType.svg_text));
            //datas.Add(new HtmlDataItem("红外干燥设定温度", ConvertSignalValue(commonDAO.GetSignalDataValue(machineCode, "红外干燥设定温度"), "℃"), eHtmlDataItemType.svg_text));
            ...
            //else
            //    datas.Add(new HtmlDataItem("发送站", green, eHtmlDataItemType.svg_blinkcolor));
            datas.Add(new HtmlDataItem("红外干燥温度", commonDAO.GetSignalDataValue(machineCode, "红外干燥设定温度"), eHtmlDataItemType.svg_text));
            string keys = string.Empty;
            foreach (var item in strsingna)
            {
                string value = commonDAO.GetSignalDataValue(machineCode, item);
                if (value == "1") {
                    keys += item;
                }
            }
            ...
            //value = commonDAO.GetSignalDataValue(machineCode, "全自动存样工作站1");
            //datas.Add(new HtmlDataItem("发送站样瓶", value == "1" ? red : green, eHtmlDataItemType.svg_blinkcolor));
            //datas.Add(new HtmlDataItem("发送站样瓶号", commonDAO.GetSignalDataValue(machineCode, "样罐芯片码"), eHtmlDataItemType.svg_text));

            #endregion

            datas.Add(new HtmlDataItem("制样编码", commonDAO.GetSignalDataValue(machineCode, "制样编码"), eHtmlDataItemType.svg_text));
            datas.Add(new HtmlDataItem("制样开始时间", commonDAO.GetSignalDataValue(machineCode, "开始时间"), eHtmlDataItemType.svg_text));
            datas.Add(new HtmlDataItem("煤种", getMeiZhongByStatus(commonDAO.GetSignalDataValue(machineCode, "煤种")), eHtmlDataItemType.svg_text));
            datas.Add(new HtmlDataItem("水分", getShuiFenByStatus(commonDAO.GetSignalDataValue(machineCode, "水分")), eHtmlDataItemType.svg_text));
            datas.Add(new HtmlDataItem("粒度", getLiDuByStatus(commonDAO.GetSignalDataValue(machineCode, "粒度")), eHtmlDataItemType.svg_text));
            ...
            //datas.Add(new HtmlDataItem("制样开始时间", getMeiZhongByStatus(commonDAO.GetSignalDataValue(machineCode, "开始时间")), eHtmlDataItemType.svg_text));
            //datas.Add(new HtmlDataItem("煤种", getMeiZhongByStatus(commonDAO.GetSignalDataValue(machineCode, "煤种")), eHtmlDataItemType.svg_text));
            //datas.Add(new HtmlDataItem("水分", getShuiFenByStatus(commonDAO.GetSignalDataValue(machineCode, "水分")), eHtmlDataItemType.svg_text));
            //datas.Add(new HtmlDataItem("粒度", getLiDuByStatus(commonDAO.GetSignalDataValue(machineCode, "粒度")), eHtmlDataItemType.svg_text));
