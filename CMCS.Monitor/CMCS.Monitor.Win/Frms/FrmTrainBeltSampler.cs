...
namespace CMCS.Monitor.Win.Frms
{
    public partial class FrmTrainBeltSampler : MetroForm
    {
        ...
        void RequestData()
        {
            ...
            datas.Add(new HtmlDataItem("皮带采样机1弃料提升斗", value == "运行" ? "Red" : "url(#linearGradient6035-9)", eHtmlDataItemType.svg_color));
            value = commonDAO.GetSignalDataValue(machineCode, "转运皮带");
            datas.Add(new HtmlDataItem("皮带采样机1输煤皮带", value == "运行" ? "Red" : "#808080", eHtmlDataItemType.svg_color));
            value = commonDAO.GetSignalDataValue(machineCode, "给料皮带");
            datas.Add(new HtmlDataItem("皮带采样机1初级给料", value == "运行" ? "Red" : "#808080", eHtmlDataItemType.svg_color));
            value = commonDAO.GetSignalDataValue(machineCode, "破碎");
            datas.Add(new HtmlDataItem("皮带采样机1初级破碎1", value == "运行" ? "Red" : "url(#linearGradient5969-9)", eHtmlDataItemType.svg_color));
            datas.Add(new HtmlDataItem("皮带采样机1初级破碎2", value == "运行" ? "Red" : "url(#linearGradient5919-2)", eHtmlDataItemType.svg_color));
            datas.Add(new HtmlDataItem("皮带采样机1初级破碎3", value == "运行" ? "Red" : "url(#linearGradient5921-4)", eHtmlDataItemType.svg_color));
            datas.Add(new HtmlDataItem("皮带采样机1初级破碎4", value == "运行" ? "Red" : "url(#linearGradient5923-5)", eHtmlDataItemType.svg_color));
            datas.Add(new HtmlDataItem("皮带采样机1初级破碎5", value == "运行" ? "Red" : "url(#linearGradient5925-5)", eHtmlDataItemType.svg_color));
            value = commonDAO.GetSignalDataValue(machineCode, "缩分皮带");
            datas.Add(new HtmlDataItem("皮带采样机1次级给料", value == "运行" ? "Red" : "#808080", eHtmlDataItemType.svg_color));
            value = commonDAO.GetSignalDataValue(machineCode, "缩分机");
            datas.Add(new HtmlDataItem("皮带采样机1缩分器1", value == "运行" ? "Red" : "url(#linearGradient7572)", eHtmlDataItemType.svg_color));
            datas.Add(new HtmlDataItem("皮带采样机1缩分器2", value == "运行" ? "Red" : "url(#linearGradient5931-6)", eHtmlDataItemType.svg_color));
            datas.Add(new HtmlDataItem("皮带采样机1缩分器3", value == "运行" ? "Red" : "url(#linearGradient6946)", eHtmlDataItemType.svg_color));
            datas.Add(new HtmlDataItem("皮带采样机1缩分器4", value == "运行" ? "Red" : "url(#linearGradient5939-1)", eHtmlDataItemType.svg_color));
            datas.Add(new HtmlDataItem("皮带采样机1缩分器5", value == "运行" ? "Red" : "url(#linearGradient5941-4)", eHtmlDataItemType.svg_color));
            datas.Add(new HtmlDataItem("皮带采样机1缩分器6", value == "运行" ? "Red" : "url(#linearGradient5905-1)", eHtmlDataItemType.svg_color));
            datas.Add(new HtmlDataItem("皮带采样机1缩分器7", value == "运行" ? "Red" : "url(#linearGradient7623)", eHtmlDataItemType.svg_color));
            ...
            value = commonDAO.GetSignalDataValue(machineCode, "弃料提升斗");
            datas.Add(new HtmlDataItem("皮带采样机2弃料提升斗", value == "运行" ? "Red" : "url(#linearGradient6035-9-6)", eHtmlDataItemType.svg_color));
            value = commonDAO.GetSignalDataValue(machineCode, "转运皮带");
            datas.Add(new HtmlDataItem("皮带采样机2输煤皮带", value == "运行" ? "Red" : "#808080", eHtmlDataItemType.svg_color));
            value = commonDAO.GetSignalDataValue(machineCode, "给料皮带");
            datas.Add(new HtmlDataItem("皮带采样机2初级给料", value == "运行" ? "Red" : "#808080", eHtmlDataItemType.svg_color));
            value = commonDAO.GetSignalDataValue(machineCode, "破碎");
            datas.Add(new HtmlDataItem("皮带采样机2初级破碎1", value == "运行" ? "Red" : "url(#linearGradient5969-9-7)", eHtmlDataItemType.svg_color));
            datas.Add(new HtmlDataItem("皮带采样机2初级破碎2", value == "运行" ? "Red" : "url(#linearGradient5919-2-2)", eHtmlDataItemType.svg_color));
            datas.Add(new HtmlDataItem("皮带采样机2初级破碎3", value == "运行" ? "Red" : "url(#linearGradient5921-4-3)", eHtmlDataItemType.svg_color));
            datas.Add(new HtmlDataItem("皮带采样机2初级破碎4", value == "运行" ? "Red" : "url(#linearGradient5923-5-2)", eHtmlDataItemType.svg_color));
            datas.Add(new HtmlDataItem("皮带采样机2初级破碎5", value == "运行" ? "Red" : "url(#linearGradient5925-5-2)", eHtmlDataItemType.svg_color));
            value = commonDAO.GetSignalDataValue(machineCode, "缩分皮带");
            datas.Add(new HtmlDataItem("皮带采样机2次级给料", value == "运行" ? "Red" : "#808080", eHtmlDataItemType.svg_color));
            value = commonDAO.GetSignalDataValue(machineCode, "缩分机");
            datas.Add(new HtmlDataItem("皮带采样机2缩分器1", value == "运行" ? "Red" : "url(#linearGradient13273)", eHtmlDataItemType.svg_color));
            datas.Add(new HtmlDataItem("皮带采样机2缩分器2", value == "运行" ? "Red" : "url(#linearGradient5931-6-1)", eHtmlDataItemType.svg_color));
            datas.Add(new HtmlDataItem("皮带采样机2缩分器3", value == "运行" ? "Red" : "url(#linearGradient7777)", eHtmlDataItemType.svg_color));
            datas.Add(new HtmlDataItem("皮带采样机2缩分器4", value == "运行" ? "Red" : "url(#linearGradient5939-1-2)", eHtmlDataItemType.svg_color));
            datas.Add(new HtmlDataItem("皮带采样机2缩分器5", value == "运行" ? "Red" : "url(#linearGradient5941-4-7)", eHtmlDataItemType.svg_color));
            datas.Add(new HtmlDataItem("皮带采样机2缩分器6", value == "运行" ? "Red" : "url(#linearGradient5905-1-1)", eHtmlDataItemType.svg_color));
            datas.Add(new HtmlDataItem("皮带采样机2缩分器7", value == "运行" ? "Red" : "url(#linearGradient13324)", eHtmlDataItemType.svg_color));
