...
(function () {
    ...
    // 打开火车机械采样机监控界面
    HomePageV8Cef.OpenTrainMachinerySampler = function (paramSampler) {
        native function OpenTrainMachinerySampler();
        OpenTrainMachinerySampler(paramSampler);
    };
    ...
    // 打开翻车记录
    HomePageV8Cef.OpenTrainRecognition = function () {
        native function OpenTrainRecognition();
        OpenTrainRecognition();
    };
