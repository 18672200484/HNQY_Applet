...
namespace DHPlaySDK
{
    ...
    public sealed class NETPlay
    {
        ...
        public static OPERATION_INFO NETThrowLastError(int nPort)
        {
        ...
        public static extern bool PLAY_OpenFile(int nPort, string sFileName);
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_CloseFile(int nPort);
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_SetCurrentFrameNum(int nPort, UInt32 nFrameNum);
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_SetPlayedTimeEx(int nPort, UInt32 nTime);
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_SetColor(int nPort, UInt32 nRegionNum, int nBrightness, int nContrast, int nSaturation, int nHue);
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_SetStreamOpenMode(int nPort, UInt32 nMode);
        #endregion
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_PlaySound(int nPort);
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_StopSound();
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_PlaySoundShare(int nPort);
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_StopSoundShare(int nPort);
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_SetVolume(int nPort, UInt32 nVolume);
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern UInt32 PLAY_GetVolume(int nPort);
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_AdjustWaveAudio(int nPort, int nCoefficient);
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_OpenStreamEx(int nPort, IntPtr pFileHeadBuf, UInt32 nSize, UInt32 nBufPoolSize);
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_InputVideoData(int nPort, IntPtr pBuf, UInt32 nSize);
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_InputAudioData(int nPort, IntPtr pBuf, UInt32 nSize);
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_CloseStreamEx(int nPort);
        ...
        /// <returns></returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_SetSecurityKey(int nPort, IntPtr szKey, UInt32 nKeylen);
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_ResetBuffer(int nPort, UInt32 nBufType);
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_Pause(int nPort, UInt32 nPause);
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_OneByOneBack(int nPort);
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern UInt32 PLAY_GetLastError(int nPort);
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_SetDecCallBack(int nPort,ref DecCBFun cbFun);
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_SetDecCBStream(int nPort, UInt32 nStream);
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_SetDisplayCallBack(int nPort, DisplayCBFun dCBFun, int nUser);
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_SetAudioCallBack(int nPort, FunAudio funAudio, int nUser);
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_SetDisplayRegion(int nPort, UInt32 nRegionNum,IntPtr pSrcRect, IntPtr hDestWnd, bool bEnable);
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_RefreshPlayEx(int nPort, UInt32 nRegionNum);
        ...
        [DllImport(@"DH\dhplay.dll")]
        public static extern UInt32 PLAY_GetCurrentFrameNum(int nPort);
        ...
        [DllImport(@"DH\dhplay.dll")]
        public static extern UInt32 PLAY_GetFileTime(int nPort);
        ...
        /// </returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern Int16 PLAY_GetCaps();
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_GetColor(int nPort, UInt32 nRegionNum, ref int pBrightness, ref int pContrast, ref int pSaturation, ref int pHue);
        ...
        [DllImport(@"DH\dhplay.dll")]
        public static extern UInt32 PLAY_GetCurrentFrameRate(int nPort);
        ...
        [DllImport(@"DH\dhplay.dll")]
        public static extern UInt32 PLAY_GetPlayedTime(int nPort);
        ...
        /// <returns>file's current playing time</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern UInt32 PLAY_GetPlayedTimeEx(int nPort);
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_GetPictureSize(int nPort, ref int pWidth, ref int pHeight);
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_QueryInfo(int nPort, int nType, IntPtr pBuf, int nBufLen, ref int pRetLen);
        ...
        [DllImport(@"DH\dhplay.dll")]
        public static extern UInt32 PLAY_GetSdkVersion();
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_ConvertToBmpFile(ref string pBuf, int nSize, int nWidth, int nHeight, int nType,ref string  sFileName);
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_StartDataRecord(int nPort,string sFileName,int idataType);
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_StopDataRecord(int nPort);
        ...
        public static extern  bool PLAY_GetFreePort(IntPtr pnPort);
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_SetPlayDirection(int nPort, UInt32 emDirection);
        #endregion
        ...
        /// <returns>true:succeed;false:failed</returns>
        [DllImport(@"DH\dhplay.dll")]
        public static extern bool PLAY_RigisterDrawFun(int nPort, DrawFun privateDrawFun, int nUser);
