...
namespace CMCS.Monitor.Win.Utilities
{
    ...
    public sealed class NETClient
    {
        ...
        /// </summary>
        public static bool pShowException = false;
        ...
        /// </summary>
        public static OPERATION_INFO pErrInfo;
        ...
        /// </summary>
        public static Encoding pEncoding=Encoding.GetEncoding(936);
        ...
        public static void NETThrowLastError()
        {
        ...
        public static string NETGetLastErrorName(uint errorCode)
        {
            switch (errorCode)
            {
                case 0x80000000 | 1:
        ...
        public static void NETThrowLastError(int returnValue)
        {
            if (returnValue == 0)
            {
                NETThrowLastError();
        ...
        public static void NETThrowLastError(bool returnValue)
        {
        ...
        /// </summary>
        /// <param name="e"></param>
        public static void NETThrowLastError(Exception e)
        {
        ...
        /// <param name="waittime">waittime</param>
        /// <returns>true:succeed;false:fail</returns>
        public static bool PGetDevConfig(int lLoginID, int lChannel, CONFIG_COMMAND dwCommand, ref object obj, Type typeName, int waittime)
        {
            bool returnValue = false;
        ...
        /// <param name="waittime">waittime</param>
        /// <returns>true:succeed;false:fail</returns>
        public static bool PGetDevConfig(int lLoginID, CONFIG_COMMAND dwCommand, ref object[] obj, Type typeName, int waittime)
        {
            bool returnValue = false;
            IntPtr pBoxInfo = IntPtr.Zero;
            try
        ...
        /// <param name="waittime">waittime</param>
        /// <returns>true:succeed;false:fail</returns>
        public static bool PSetDevConfig(int lLoginID, int lChannel, CONFIG_COMMAND dwCommand, object obj, Type typeName, int waittime)
        {
            bool returnValue = false;
            IntPtr pBoxInfo = IntPtr.Zero;
            try
        ...
        /// <param name="waittime">waittime</param>
        /// <returns>true:succeed;false:fail</returns>
        public static bool PSetDevConfig(int lLoginID, CONFIG_COMMAND dwCommand,object[] obj, Type typeName, int waittime)
        {
            bool returnValue = false;
            IntPtr pBoxInfo = IntPtr.Zero;
            try
        ...
        public static NET_TIME ToNetTime(DateTime dateTime)
        {
        ...
        public static DateTime ToDateTime(NET_TIME netTime)
        {
            try
            {
        ...
        public static void VIDEOThrowLastError()
        {
            Int32 errorCode = CLIENT_GetLastError();
            if (errorCode != 0)
            {
        ...
        /// <param name="errorCode">Error code</param>
        /// <returns>Standard equipment error message description</returns>
        public static string VIDEOGetLastErrorName(uint errorCode)
        {
            switch (errorCode)
            {
                case 0x80000000 | 1:
        ...
        public static void VIDEOThrowLastError(int returnValue)
        {
            if (returnValue == 0)
            {
                VIDEOThrowLastError();
        ...
        public static void VIDEOThrowLastError(bool returnValue)
        {
            if (returnValue == false)
            {
                VIDEOThrowLastError();
        ...
        /// </summary>
        /// <param name="e"></param>
        public static void VIDEOThrowLastError(Exception e)
        {
        ...
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern int CLIENT_StartService(ushort wPort, string pIp, fServiceCallBack pfscb, int dwTimeOut, IntPtr dwUserData);
        ...
        /// <returns>true:success;false:failure</returns>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern bool CLIENT_SetDeviceMode(int lLoginID, EM_USEDEV_MODE emType, IntPtr pValue);
        ...
        /// <returns>Failure to return 0,Successful return talkID</returns>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern int CLIENT_StartTalkEx(int lLoginID, fAudioDataCallBack pfcb, IntPtr dwUser);
        /// <summary>
        /// Stop Talk
        /// </summary>
        /// <param name="lTalkHandle">CLIENT_StartTalkEx return value</param>
        /// <returns>Failure to return false,Successful return true</returns>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern bool CLIENT_StopTalkEx(int lTalkHandle);
        /// <summary>
        /// Send Audio Data To Devcie 
        /// </summary>
        /// <param name="lTalkHandle">CLIENT_StartTalkEx return value</param>
        ...
        /// <returns>Send Data Length</returns>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern int CLIENT_TalkSendData(int lTalkHandle, byte[] pSendBuf, int dwBufSize);
        /// <summary>
        ...
        /// <returns>true:success;false:failure</returns>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern bool CLIENT_DHPTZControl(int lLoginID, int nChannelID, ushort dwPTZCommand, ushort param1, ushort param2, ushort param3, bool dwStop, IntPtr intPtr);
        ...
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern int CLIENT_PlayBackByTimeEx2(int lLoginID, int nChannelID, ref NET_IN_PLAY_BACK_BY_TIME_INFO pstNetIn, ref NET_OUT_PLAY_BACK_BY_TIME_INFO pstNetOut);
        ...
        public static extern bool  CLIENT_PlayBackControlDirection(int lPlayHandle, bool bBackward);

        [DllImport(@"DH\dhnetsdk.dll")]
        //get play current time   
        public static extern bool CLIENT_GetPlayBackOsdTime(int lPlayHandle, out NET_TIME lpOsdTime, out NET_TIME lpStartTime, out NET_TIME lpEndTime);
        ...
        /// </summary>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern bool CLIENT_QueryRecordState(int lLoginID, byte[] pRSBuffer, int maxlen, ref int nRSBufferlen, int waittime);

        /// <summary>
        ///Setup Record State
        /// </summary>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern bool CLIENT_SetupRecordState(int lLoginID, byte[] pRSBuffer, int nRSBufferlen);
        ...
        /// <returns>true:success;false:failure</returns>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern bool CLIENT_QuerySystemInfo(int lLoginID, int nSystemType, IntPtr pSysInfoBuffer, int maxlen, ref  int nSysInfolen, int waittime);

        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern bool CLIENT_QueryDevState(int lLoginID, int nType, IntPtr pBuf, int nBufLen,ref int pRetLen, int waittime);
        ...
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern int CLIENT_DownloadByTime(int lLoginID, int nChannelId, int nRecordFileType, ref  NET_TIME tmStart, ref  NET_TIME tmEnd, string sSavedFileName, fTimeDownLoadPosCallBack cbTimeDownLoadPos, IntPtr dwUserData);
        ...
        /// <returns>true:success;false:failure</returns>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern bool CLIENT_GetNewDevConfig(Int32 lLoginID, string szCommand, Int32 nChannelID, IntPtr szOutBuffer, UInt32 dwOutBufferSize, ref UInt32 error, Int32 waittime);
        ...
        /// <returns>true:success;false:failure</returns>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern bool CLIENT_SetNewDevConfig(Int32 lLoginID, string strCommand, Int32 lChannel, IntPtr lpInBuffer, UInt32 dwInBufferSize, ref UInt32 error, ref UInt32 restart, Int32 waittime);
        ...
        /// <returns></returns>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern bool CLIENT_QueryNewSystemInfo(Int32 lLoginID, string szCommand, Int32 nChannelID, IntPtr szOutBuffer, UInt32 dwOutBufferSize, ref UInt32 error, Int32 waittime);
        ...
        /// <returns></returns>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern Int32 CLIENT_RealLoadPicture(Int32 lLoginID, Int32 nChannelID, UInt32 dwAlarmType, fAnalyzerDataCallBack cbAnalyzerData, UInt32 dwUser);
        ...
        /// <returns></returns>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern Int32 CLIENT_RealLoadPictureEx(Int32 lLoginID, Int32 nChannelID, UInt32 dwAlarmType, bool bNeedPicFile, fAnalyzerDataCallBack cbAnalyzerData, UInt32 dwUser, IntPtr Reserved);
        ...
        /// <returns></returns>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern bool CLIENT_StopLoadPic(Int32 lAnalyzerHandle);
        ...
        /// <returns></returns>
        [DllImport(@"DH\dhconfigsdk.dll")]
        public static extern bool CLIENT_PacketData(string strCommand, IntPtr lpInBuffer, UInt32 dwInBufferSize, IntPtr szOutBuffer, UInt32 dwOutBufferSize);
        ...
        /// <returns></returns>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern Int32 CLIENT_DownloadMediaFile(Int32 lLoginID,EM_FILE_QUERY_TYPE emType, IntPtr lpMediaFileInfo, string sSavedFileName, fDownLoadPosCallBack cbDownLoadPos, UInt32 dwUserData,  IntPtr reserved);
        ...
        /// <returns></returns>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern bool CLIENT_StopDownloadMediaFile(Int32 lFileHandle);
        ...
        /// <returns></returns>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern Int32	CLIENT_FindFileEx(Int32 lLoginID, EM_FILE_QUERY_TYPE emType, IntPtr pQueryCondition, IntPtr reserved, Int32 waittime);	
        ...
        /// <returns></returns>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern Int32 CLIENT_FindNextFileEx(Int32 lFindHandle, Int32 nFilecount, IntPtr pMediaFileInfo, Int32 maxlen, IntPtr reserved, Int32 waittime);
        ...
        /// <returns></returns>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern bool CLIENT_FindCloseEx(Int32 lFindHandle);

        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern bool CLIENT_SnapPicture(Int32 lLoginID, SNAP_PARAMS par);

        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern void CLIENT_SetSnapRevCallBack(fSnapRev OnSnapRevMessage, Int32 dwUser);


        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern Int32 CLIENT_StartSearchDevices(fSearchDevicesCB cbSearchDevices, IntPtr pUserData, IntPtr szLocalIp);
        ...
        /// </summary>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern Int32 CLIENT_StartUpgradeEx(Int32 lLoginID, EM_UPGRADE_TYPE emType, string pchFileName, fUpgradeCallBack cbUpgrade, UInt32 dwUser);

        // <summary>
        /// Sending data
        /// </summary>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern bool CLIENT_SendUpgrade(Int32 lUpgradeID);
        ...
        /// </summary>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern bool CLIENT_StopUpgrade(Int32 lUpgradeID);

        // <summary>
        /// Set Device Time
        /// </summary>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern bool CLIENT_SetupDeviceTime(Int32 lLoginID, ref NET_TIME pDeviceTime);

        // <summary>
        /// Query Device Time
        /// </summary>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern bool CLIENT_QueryDeviceTime(int lLoginID, out NET_TIME pDeviceTime, int waittime = 1000);
        ...
        /// </summary>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern bool CLIENT_QueryTransComParams(int lLoginID, int TransComType, out NET_COMM_STATE pCommState, int nWaitTime);
        ...
        /// </summary>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern int CLIENT_CreateTransComChannel(int lLoginID, int TransComType, uint baudrate, uint databits, uint stopbits, uint parity, fTransComCallBack cbTransCom, IntPtr dwUser);

        // <summary>
        /// Send Data To Transcom Channel
        /// </summary>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern bool CLIENT_SendTransComData(int lTransComChannel, string pBuffer, int dwBufSize);

        // <summary>
        /// Destroy Transcom Channel
        /// </summary>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern bool CLIENT_DestroyTransComChannel(int lTransComChannel);
        ...
        /// <returns></returns>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern bool CLIENT_LoadMonitorWallCollection(Int32 lLoginID, IntPtr pInParam ,  IntPtr pOutParam ,  Int32 waittime);
        ...
        /// <returns></returns>
        [DllImport(@"DH\dhnetsdk.dll")]
        public static extern bool CLIENT_SaveMonitorWallCollection(Int32 lLoginID, IntPtr pInParam , IntPtr pOutParam ,  Int32 waittime);
