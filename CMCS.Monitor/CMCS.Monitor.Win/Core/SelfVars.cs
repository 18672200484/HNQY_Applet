...
namespace CMCS.Monitor.Win.Core
{
	...
	public static class SelfVars
	{
		...
		/// <summary>
		/// 网页地址 - 南昌光明南昌光明存样柜气动传输
		/// </summary>
		public static string Url_NCGM_CYGQDCS = System.IO.Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Web/AutoCupboardPneumaticTransfer/index.htm");
